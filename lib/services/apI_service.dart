...
class ApiService {
  ...
  static const String _readAccessToken = 'Bearer eyJhbGciOiJIUzI1NiJ9...utySGyI'; // disingkat buat rapi
  ...
  static Future<List<Movie>> fetchPopularMovies({int page = 1}) async {
    final uri = Uri.parse('$_baseUrl/movie/popular?api_key=$_apiKey&page=$page');
