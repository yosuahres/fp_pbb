...
class _TicketSeatScreenState extends State<TicketSeatScreen> {
        ...
        .listen(
          (snapshot) {
            if (snapshot.docs.isNotEmpty) {
              setState(() {
                _allSeats =
                    snapshot.docs
                        .map((doc) => Seat.fromFirestore(doc))
                        .toList();
                _isLoading = false;
              });
            } else {
          ...
          onError: (error) {
            ...
            ScaffoldMessenger.of(
              context,
            ).showSnackBar(SnackBar(content: Text("bad: $error")));
          },
        );
  }
  ...
  Widget build(BuildContext context) {
    List<Seat> currentlySelectedSeats =
        _allSeats
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: FilledButton(
                                      ...
                                      onPressed:
                                          _selectedSeatDocIds.isNotEmpty &&
                                                  !_isLoading
                                              ? () {
